...
-- ---------------------------------------------------------------------------
drop table if exists public.raport, public.sidang_dk, public.sidang_urut, public.pengaturan,
...
grant select on public.profiles, public.sku_butir, public.sku_unit, public.pf_item, public.sku_progress,
  ...
  public.materi, public.pengaturan, public.sidang_dk, public.sidang_urut, public.raport to authenticated;
