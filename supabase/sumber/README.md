...
| 10-26 | tabel: inti (profil, SKU, absensi), iuran, penugasan+dewan, dokumen, notifikasi, naik kelas, agenda+usulan, portofolio/sidang/raport/instrumen, berkas Garuda+indeks FK, keep-alive, sesi ujian+login, pra-uji, pelantikan+Saka, TKK |
...
| 50-69 | fungsi aksi `sg_*`: SKU+penegakan, garuda/jurnal/absensi, iuran, penugasan, naik kelas, anggota+jenis kelamin+jabatan dewan, materi/sidang/raport, instrumen+verifikasi, berkas Garuda+gudep, dokumen, notifikasi+pemeriksaan data, cadangan+eskalasi, agenda+usulan, sesi ujian+fungsi Edge Function |
