...
const PEMBINA = {
  ...
  bagian: [
    ...
    { id: 'pembina-salinan-beku', judul: 'Salinan beku portofolio dan tabel pendataan', isi: ['Di halaman Portofolio format Kwarcab, panel Salinan beku menyimpan dokumen saat ini apa adanya sebagai arsip yang dicetak atau dikirim ke Kwarcab: identitas, TKK, Saka, Krida, SPG, data diri, rubrik surat guru, dan data gudep pada saat itu. Tulis catatan (mis. tanggal penyerahan) lalu tekan Bekukan salinan sekarang. Salinan dapat dibuka kembali dengan Buka dan tidak berubah walau data aplikasi atau Data Gudep berubah kemudian; Kembali ke data terkini menampilkan dokumen yang mengikuti data terbaru. Paling banyak 20 salinan per Penegak; salinan yang tidak diperlukan dapat dihapus. Salinan memuat data pribadi Penegak dan hanya dapat dibaca Pembina dan Admin. Di menu Kelayakan, tombol Unduh tabel pendataan (Excel) menghasilkan tabel Pendataan dan Verifikasi Syarat Awal Calon Penegak Garuda (nama, NTA atau NIS, tanggal lantik Laksana, masa Laksana, tanggal lahir, usia, status kuota, saran aplikasi, dan kolom Verifikasi Pembina yang Anda isi sendiri). Kolom saran hanya bantuan; keputusan eligible tetap pada Pembina.'] },
