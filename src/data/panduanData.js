...
const PENEGAK = {
  ...
  bagian: [
    ...
    { id: 'penegak-tkk', judul: 'TKK (Tanda Kecakapan Khusus)', isi: ['Menu TKK menampilkan TKK yang sudah kamu lulus (tingkat Purwa, Madya, atau Utama, lengkap dengan tanggal dan pengujinya) dan kemajuan menuju syarat Garuda: total TKK, TKK Madya ke atas, dan TKK wajib bertingkat Utama. TKK dapat dikenakan sesudah kamu lulus SKU Bantara; Pembina yang mencatatnya setelah kamu lulus uji tim 2 orang dan telah melatih sedikitnya seorang Pramuka. Standar 45 TKK adalah standar lokal Kwarcab dan Kwarran, bukan bagian SK 038/2017.'] },
...
const ADMIN = {
  ...
  bagian: [
    ...
    { id: 'admin-tkk', judul: 'TKK (Tanda Kecakapan Khusus)', isi: ['Sama dengan Pembina: menu TKK untuk mencatat capaian TKK dan TKK Krida serta mengatur ambang kesiapan Garuda (jumlah TKK, jumlah Madya, dan daftar TKK wajib Utama).'] },
