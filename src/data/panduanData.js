  ...
  bagian: [
    ...
    { id: 'dewan-tindaklanjut', judul: 'Tindak Lanjut', isi: ['Daftar Penegak yang lama tidak bergerak (SKU, absensi, atau iuran); tombol untuk membuka WhatsApp dengan pesan pengingat siap kirim.'] },
    {
      ...
      isi: [
        ...
        'Mengelola Kepengurusan Dewan Ambalan bersama Pembina (formulir satu per satu atau unggah Excel).',
      ],
    },
  ],
};
...
const PEMBINA = {
  ...
  bagian: [
    ...
    { id: 'pembina-kepengurusan', judul: 'Kepengurusan', isi: ['Menetapkan jabatan Dewan Ambalan (Pradana, Pradani, dan lainnya) untuk Penegak aktif, satu per satu atau lewat berkas Excel.'] },
    { id: 'pembina-pemeriksaan', judul: 'Pemeriksaan Data', isi: ['Daftar data yang belum lengkap (NTA, jenis kelamin, rombel format lama, dan lainnya) lengkap dengan tautan langsung untuk memperbaikinya.'] },
