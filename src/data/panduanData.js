...
const PEMBINA = {
  ...
  bagian: [
    ...
    { id: 'pembina-kelayakan', judul: 'Kelayakan Calon Garuda', isi: ['Menu Kelayakan menampilkan, untuk Penegak yang SKU-nya selesai atau sudah terdaftar sebagai Calon Garuda, tiga syarat gerbang (kelas minimal, usia, SKU), kemajuan SPG, dan kuota calon (bawaan 5% dari Penegak aktif). Semuanya peringatan: aplikasi tidak memblokir pendaftaran, keputusan akhir tetap pada Pembina dan Kwarcab. Isi tanggal lahir Penegak lewat tombol Isi tanggal lahir (tanpa tanggal lahir, syarat usia berstatus Data belum ada). Aturan gerbang (kelas minimal, rentang tanggal lahir yang sah, kuota) dapat diubah di panel Aturan gerbang calon dan diperbarui tiap tahun sesuai pedoman Kwarcab.'] },
...
const ADMIN = {
  ...
  bagian: [
    ...
    { id: 'admin-kelayakan', judul: 'Kelayakan Calon Garuda', isi: ['Sama dengan Pembina: menu Kelayakan untuk mengisi tanggal lahir Penegak dan mengubah aturan gerbang calon (kelas minimal, rentang tanggal lahir, kuota persen). Gerbang hanya peringatan. Tanggal lahir disimpan terpisah dan hanya dapat dibaca pemilik dan pengurus.'] },
