...
const USERS = [
  ...
  peserta('u-p1', 'Ahmad Fauzi', '10231', 'X', 'Sangga Elang', 'Islam'),
  peserta('u-p2', 'Siti Nurhaliza', '10232', 'X', 'Sangga Merak', 'Islam'),
  peserta('u-p3', 'Dimas Prasetyo', '10118', 'XI', 'Sangga Elang', 'Protestan'),
  peserta('u-p4', 'Rina Wulandari', '10119', 'XI', 'Sangga Merak', 'Katolik'),
  { ...peserta('u-p5', 'Bagas Saputra', '10007', 'XII', 'Sangga Rajawali', 'Islam'), calonGaruda: tanggalLalu(45) },
  peserta('u-p6', 'Nadia Putri', '10008', 'XII', 'Sangga Kasuari', 'Islam'),
  peserta('u-p7', 'Rizky Ramadhan', '10233', 'X', 'Sangga Rajawali', 'Islam'),
  peserta('u-p8', 'Anisa Fitriani', '10120', 'XI', 'Sangga Kasuari', 'Islam'),
  { ...peserta('u-p9', 'Wahyu Hidayat', '10009', 'XII', 'Sangga Elang', 'Islam'), calonGaruda: tanggalLalu(60) },
  peserta('u-p10', 'Made Ayu Saraswati', '10121', 'XI', 'Sangga Merak', 'Hindu'),
  peserta('u-p11', 'Kevin Wijaya', '10234', 'X', 'Sangga Kasuari', 'Buddha'),
  peserta('u-p12', 'Maria Goretti', '10010', 'XII', 'Sangga Rajawali', 'Katolik'),
];
