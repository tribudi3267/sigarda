...
ok(contoh.role === 'peserta' && contoh.nama === 'Ahmad Fauzi' && contoh.kelas === 'X' && contoh.sangga === 'Sangga Elang' && contoh.agama === 'Islam' && contoh.nis === '10231' && contoh.wajibGantiPin === false && contoh.dibuat === '2025-07-01', 'bentuk profil Penegak');
...
r = await apiA.buatAkun('peserta', [{ nama: 'X', nis: '99999', kelas: 'X', sangga: 'S', agama: 'Islam' }]);
