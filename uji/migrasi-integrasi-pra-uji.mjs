...
const A = await baru('git:810f6cc'); // skema TEPAT sesudah migrasi ini (main sesudah Fase E); skema.sql terbaru memuat tahap sesudahnya (pelantikan dan Saka menulis ulang sg_cadangan_admin)
