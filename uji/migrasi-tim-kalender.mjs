...
const MK = bersih(readFileSync(`${P}/supabase/migrasi/2026-09-pengingat-kalender.sql`, 'utf8'));
const MC = bersih(readFileSync(`${P}/supabase/migrasi/2026-09-cakupan-pra-uji.sql`, 'utf8')); // idem: migrasi sesudahnya // sesudah migrasi ini; skema.sql terbaru sudah memuatnya, jadi dijalankan sebelum katalog dibandingkan
