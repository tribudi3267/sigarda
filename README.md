...
**Butir agama (sub-butir Butir 1) hanya dinilai oleh Pembina.** Dewan Ambalan menilai butir lainnya. Aturan ini ditegakkan di server: pencatatan hasil (mulai uji, lulus, perlu diulang, dikembalikan, termasuk lewat instrumen) oleh Dewan Ambalan ditolak, dan pada pengajuan butir agama Penegak hanya dapat memilih Pembina sebagai penguji. Di layar, tombol dan chip butir agama tidak dapat dibuka Dewan Ambalan. Hasil yang sudah dicatat Dewan sebelum aturan ini tidak diubah; Pembina dapat meninjaunya.
...
- **Pradana** dan **Pradani** tidak diketik di Data Gudep: keduanya adalah **anggota Dewan Ambalan yang diberi jabatan** itu (lihat "Jabatan Dewan Ambalan" di bawah).
### Jabatan Dewan Ambalan (Pradana dan Pradani)
Di menu **Anggota** (tab Dewan Ambalan), Admin dapat mengisi **Jabatan Dewan Ambalan** dan **NTA** pada tiap anggota Dewan: Pradana, Pradani, Wakil Pradana, Wakil Pradani, Sekretaris, atau Bendahara (boleh kosong). Jabatan juga bisa diisi lewat template import Excel Dewan (kolom "Jabatan Dewan" dan "NTA").
- **Pradana dan Pradani hanya satu orang.** Memilih jabatan yang sudah dipegang orang lain memunculkan pemberitahuan; bila disimpan, pemegang lama otomatis menjadi anggota Dewan biasa (satu permintaan, semua atau tidak sama sekali). Server menolak dua Pradana.
